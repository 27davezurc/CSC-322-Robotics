...
// Test sensors before on Infrared File

// 1K Resistors on IR LEDS
// Brown-Black-Red

// Check servo pins and swap if needed
// Check Left and Right IR LED/Receiver on BPF assignment
...
void loop()                                  // Main loop auto-repeats
{
  ...
  driveServos(driveLeft, driveRight, 20);       // Drive levels set speeds
}
...
void driveServos(int speedLeft, int speedRight, int msTime)
{
